...
namespace UpdateDatabase
{
    public class Deployer
    {
        ...
        public Deployer(IProvideDacVersion versionProvider, DacHistory historyProvider)
        {
        ...
        public void Deploy(string publishSettingsFile)
        {
            ...
            {
                Console.WriteLine();
                Console.WriteLine("Applying upgrade #{0}: Moving from version {1} to {2}.", ++count, currentVersion, latest.Version);
                Console.WriteLine();
